                            ...
                            <div
                                className={
                                    showUserDetailsModal
                                        ? 'mt-20 h-auto w-auto dark:bg-gray-800 bg-white p-0 border dark:border-gray-800 rounded-xl z-20 transition-all ease-in-out'
                                        : 'mt-20 h-0 w-0 dark:bg-gray-800 bg-white p-0 border dark:border-gray-800 rounded-xl z-20 transition-all ease-in-out'
                                }
                            >
                                ...
                                <div className="mt-40 pb-4">
                                    ...
                                    <ul className="list-none mx-8 mt-10 mb-7">
                                        <li className="border-b py-3 group dark:border-gray-600 flex items-center cursor-pointer hover:bg-gray-800 dark:hover:bg-gray-900 px-3 transition-all ease-in-out">
                                            <span className="material-icons-outlined group-hover:text-white mr-2 text-xs">
                                                message
                                            </span>
                                        ...
                                        <li className="border-b py-3 dark:border-gray-600 flex items-center cursor-pointer dark:hover:bg-gray-900 hover:bg-gray-800 group px-3 transition-all ease-in-out">
                                            <span className="material-icons-outlined group-hover:text-white mr-2 text-xs">
                                                call
                                            </span>
                                            <span className="group-hover:text-white">
                                        ...
                                        <li className="border-b py-3 dark:border-gray-600 flex items-center cursor-pointer dark:hover:bg-gray-900 hover:bg-gray-800 group px-3 transition-all ease-in-out">
                                            <span className="material-icons-outlined group-hover:text-white mr-2 text-xs text-red-700 font-bold">
                                                block
                                            </span>
                                            <span className="group-hover:text-white">
                                                Block this user
